...
{% accordion "section","2", "A11y Rules Soundbites" %}
...
{% accordion "section","2", "Next Trip Podcast" %}
...
{% accordion "section","2", "Non-rev Lounge" %}
...
{% accordion "section","2", "That Real Blind Tech Show" %}
...
{% accordion "section","2", "Working Blind" %}
